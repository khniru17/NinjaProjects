 ...
 * this class is used to hold variables for firstname, lastname, phone number and email
 * this has getter and setter methods. The data from the file is stored as array list of objects
 */
public class ContactObject implements Serializable {
    ...
    public ContactObject(String firstName, String lastName, String phoneNumber, String emailId) {
    ...
    public int compareTo(ContactObject contactObject) {
        return this.getFirstName().compareTo(contactObject.getFirstName());
    }
